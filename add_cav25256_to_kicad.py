#!/usr/bin/env python3
"""
Add CAV25256 component library to KiCad project
"""
import json
import os
import sys
...
def add_cav25256_to_project(project_file=None):
    """Add CAV25256 library to KiCad project"""
    ...
    print("=" * 60)
    print("Adding CAV25256 Library to KiCad Project")
    print("=" * 60)
    ...
    if not symbol_lib.exists():
        ...
        print("[INFO] Run download_cav25256_library.py first!")
        return False
    ...
    print("\n" + "=" * 60)
    print("SUCCESS! CAV25256 library added to project")
    print("=" * 60)
    print("\nNext steps:")
    print("1. Open KiCad and load the project")
    print("2. Press 'A' in schematic editor to add symbol")
    print("3. Search for 'CAV25256' or 'custom_components:CAV25256'")
    print("4. Place the component on your schematic")
    print("\n[NOTE] Verify footprint dimensions match actual component!")
...
def add_to_all_projects():
    ...
    for proj_file in project_files:
        ...
        add_cav25256_to_project(proj_file)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Add CAV25256 library to KiCad project")
    ...
    try:
        if args.all:
            ...
            success = add_cav25256_to_project(args.project)
